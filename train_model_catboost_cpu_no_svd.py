...
model_1 = CatBoostClassifier(**params_1, train_dir='train_model_catboost_cpu_no_svd_1')
model_1.fit(X_1, Y_1, eval_set=(X_1_val, Y_1_val))
model_2 = CatBoostClassifier(**params_2, train_dir='train_model_catboost_cpu_no_svd_2')
